...
public class FeatureProcessor {
	...
	protected int window_overlap_offset;
	...
	protected int[][] feature_extractor_dependencies;
	...
	// not.
	protected boolean isARFFOverallHeaderWritten = false;
	...
	protected AggregatorContainer aggregator;
...
//			aggContainer.add(aggList);
	 ...
	 */
	protected double[] preProcessRecording(File recording_file) throws Exception {
	 ...
	 *             Throws an exception if cannot write.
	 */
	protected void saveACEFeatureVectorsForARecording(
			double[][][] feature_values, int[] window_start_indices,
	 ...
	 *             Throws an exception if cannot write.
	 */
	protected void saveFeatureDefinitions(double[][][] feature_values,
